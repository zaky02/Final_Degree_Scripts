...
grid_dir = '/home/alma/zak/KRAS_LigBuilder_glide/S2_glide/grid/'
...
with open('/home/alma/zak/KRAS_LigBuilder_glide/S2_glide/grid/grid_inputs/7RPZ_pred.in', "a+") as file_object: # Add constraibts to the .in file generated for the grid
    file_object.write("\n")
